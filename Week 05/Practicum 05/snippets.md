...
<t>-- ако е глобален, се запълва с нули<br>
<t>-- ако не е глобален, т.е. е създаден в някоя функция, вкл. main(), не се знае какви стойности има(поне по стандарт, компилаторите може и да правят някакви работи) и да го четем е UB<br>
...
- принтовете са:<br>
<t>-- "1 2 3 4 5" - ясно<br>
<t>-- "0 0 0 0 0" - както казахме, arr в f() в този момент вече сочи към новия масив arr2<br>
<t>-- "1 2 3 4 5" - arr в main() никога не се променя и се принтира, както и първия път
</details>
<br>
