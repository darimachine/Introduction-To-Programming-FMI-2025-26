...
```
<br>
Този пример също е валиден. Тук вътрешният цикъл работи с променливата j, напълно различна от i-то на външния for, а вътре в самото тяло на вътрешния for си създаваме някакво друго i, което отново е в по-вътрешен scope, спрямо другото(оригиналното) i.
