...
void fromAnyBaseToAnyBase(const char *number, unsigned numberLength, unsigned fromBase, char *result,
                          unsigned &resultLength, unsigned toBase) {
...
int main() {
    {
        char number[MAX_SIZE] = {'F', 'F', '\0'};
        unsigned numberLength = 2;

        char result[MAX_SIZE] = {};
        unsigned resultLength = 0;
        fromAnyBaseToAnyBase(number, numberLength, 16, result, resultLength, 10);
        cout << result << endl;
    }
}
